...
public class LookForaBook {
     ...
     * @return True if the insertion was successful, false otherwise.
     */
    public static boolean addAddress(int addID, String streetNum, String streetName, String apartment, String city, String province, String country, String postalCode) {
        try {
     ...
     * @return True if the insertion was successful, false otherwise.
     */
    public static boolean addHasAdd(String username, int addID, boolean isShipping, boolean isBilling) {
        try {
